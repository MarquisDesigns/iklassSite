...
if ( ! class_exists( 'Callista_Smart_Slider_Widget' ) ) {

	class Callista_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description	= esc_html__( 'Display smart slider on your site.', 'callista' );
			$this->widget_id			= 'callista_widget_smart_slider';
			$this->widget_name			= esc_html__( 'Smart Slider', 'callista' );
			...
			$this->settings 			= array(
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 1,
					'label'				=> esc_html__( 'Posts count', 'callista' ),
				),
				'post_title' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display title', 'callista' ),
				),
				'content' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display content', 'callista' ),
				),
				'more_button' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display more button', 'callista' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'callista' ),
						'false_toggle'	=> esc_html__( 'Off', 'callista' ),
				...
				'more_button_text' => array(
					...
					'label'				=> esc_html__( 'More button text', 'callista' ),
				...
				'trim_words' => array(
					...
					'min_value'			=> 1,
					'step_value'		=> 1,
					'label'				=> esc_html__( 'Content words trimmed count', 'callista' ),
				),
				'width' => array(
					'type'				=> 'text',
					'value'				=> '100%',
					'label'				=> esc_html__( 'Slider width', 'callista' ),
				),
				'height' => array(
					'type'				=> 'text',
					'value'				=> '800',
					'label'				=> esc_html__( 'Slider height', 'callista' ),
				),
				'orientation' => array(
					'type'				=> 'select',
					'size'				=> 1,
					'value'				=> 'horizontal',
					'options' => array(
						'horizontal'	=> esc_html__( 'Horizontal', 'callista' ),
						'vertical'		=> esc_html__( 'Vertical', 'callista' ),
					),
					'label'				=> esc_html__( 'Slider orientation', 'callista' ),
				),
				'slide_distance' => array(
					...
					'max_value'			=> 100,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Slide distance(px)', 'callista' ),
				),
				'slide_duration' => array(
					...
					'min_value'			=> 100,
					'step_value'		=> 100,
					'label'				=> esc_html__( 'Slide duration(ms)', 'callista' ),
				),
				'slide_fade' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use fade effect?', 'callista' ),
				),
				'navigation' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use navigation?', 'callista' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'callista' ),
						'false_toggle'	=> esc_html__( 'Off', 'callista' ),
				...
				'fade_navigation' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates whether the arrows will fade in only on hover', 'callista' ),
				...
				'pagination' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use pagination?', 'callista' ),
				),
				'autoplay' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use autoplay?', 'callista' ),
				),
				'fullScreen' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display fullScreen button?', 'callista' ),
				),
				'shuffle' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates if the slides will be shuffled', 'callista' ),
				),
				'loop' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use infinite scrolling?', 'callista' ),
				),
				'thumbnails' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails?', 'callista' ),
					'toggle'			=> array(
						'true_toggle'	=> esc_html__( 'On', 'callista' ),
						'false_toggle'	=> esc_html__( 'Off', 'callista' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom'		=> esc_html__( 'Bottom', 'callista' ),
						'right'			=> esc_html__( 'Right', 'callista' ),
						'left'			=> esc_html__( 'Left', 'callista' ),
					),
					'label'				=> esc_html__( 'Sets the position of the thumbnail scroller', 'callista' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails arrows?', 'callista' ),
					'master'			=> 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'callista' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="callista-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'callista_smart_slider_default_query_args', array(
				'post_type'				=> 'post',
				'orderby'				=> 'date',
				'order'					=> 'DESC',
				'posts_per_page'		=> -1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'callista_smart_slider_title_settings', array(
				'width'				=> '100%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'callista_smart_slider_content_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '51%%',
				'show_transition'	=> 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'callista_smart_slider_more_button_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '58%%',
				'show_transition'	=> 'left',
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$html .= '<div class="smart-slider__item sp-slide">';
					$html .= $this->utility->media->get_image( array(
						'size'			=> 'callista-thumb-xl',
						'mobile_size'	=> 'callista-thumb-l',
						'class'			=> 'sp-image',
	...
	add_action( 'widgets_init', 'callista_register_smart_slider_widgets' );
	function callista_register_smart_slider_widgets() {
		register_widget( 'Callista_Smart_Slider_Widget' );
	}
}