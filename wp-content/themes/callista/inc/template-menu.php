 ...
 * @return void
 */
function callista_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon"></i>
		</button>
		<?php
			$args = apply_filters( 'callista_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'callista_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'callista' ),
			) );
 ...
 * @return void
 */
function callista_footer_menu() {
	if ( ! get_theme_mod( 'footer_menu_visibility', callista_theme()->customizer->get_default( 'footer_menu_visibility' ) ) ) {
		return;
	}
	?>
	...
	<?php
		$args = apply_filters( 'callista_footer_menu_args', array(
			...
			'depth'            => 1,
			'fallback_cb'      => 'callista_set_nav_menu',
			'fallback_message' => esc_html__( 'Set footer menu', 'callista' ),
		) );
 ...
 * @return string
 */
function callista_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'callista_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'callista_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'callista' ),
	), $context, $type );
 ...
 * @return void
 */
function callista_set_nav_menu( $args ) {
