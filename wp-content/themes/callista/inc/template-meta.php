 ...
 * @return array
 */
function callista_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	if ( ! callista_is_meta_visible( $meta, $context ) ) {
		return;
	}
	...
	$default_config = apply_filters( 'callista_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'callista_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'callista' ) . $network['name'],
