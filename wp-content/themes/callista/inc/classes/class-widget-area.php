...
if ( ! class_exists( 'Callista_Widget_Area' ) ) {

	class Callista_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'callista_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'callista_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'callista_widget_area_classes', $classes, $area_id );
	...
	function callista_widget_area() {
		return Callista_Widget_Area::get_instance();
	}

	callista_widget_area();
}
